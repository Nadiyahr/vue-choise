        ...
        <b-col>
          <div class="p-4">
            ...
            <div class="fs-xs">
              ...
              <p class="mb-5 p-2">Try new dishes when you travel or just go outside — with Choicie, you can order anything using automatic menu translation pictures of dishes. Place your order on the way to the restaurant, then just show the QR-code to the waiter. </p>
            </div>
            <div class="p-2">
              <b-button
                pill
      ...
      <b-col>
          <div class="p-4">
            ...
            <div class="fs-xs">
              ...
              <p class="mb-5 p-2">Keep private important ordering information in your account: mark the dishes you liked and didn't like, and the foods you're allergic to.</p>
            </div>
            <div class="p-2">
              <b-button
                pill
